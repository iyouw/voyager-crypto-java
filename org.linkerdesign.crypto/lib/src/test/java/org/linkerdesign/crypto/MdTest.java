...
public class MdTest {
  ...
  @Test void testSha1() {
    Sha1 sha = new Sha1();
    String hash = sha.digest(msg, EncodingType.UTF8, EncodingType.Base64);
  ...
  @Test void testMd5() {
    Md5 md = new Md5();
    String hash = md.digest(msg, EncodingType.UTF8, EncodingType.Base64);
    assertTrue(hash != null, "hash is not null");
  }

  @Test void testMd5Sha1() {
